...
public class Gerenciador
{
    ...
    public Gerenciador(Label labelPergunta,Button BTNResposta01,Button BTNRespsta02,Button BTNResposta03,Button BTNResposta04, Button BTNResposta05)
    {
    ...
    void CriarQuestoes(Label labelPergunta, Button BTNResposta01, Button BTNResposta02, Button BTNResposta03, Button BTNResposta04, Button BTNResposta05)
{
    ...
    ListaQuestoes.Add(Q100);
       ...
       public void ProximaQuestao()
        {
            var ListaQuestoes = ListaQuestoes.Where(d => d.Nivelresposta == NivelAtual).ToList();
            ...
            ListaQuestoesRespondidas.Add(QuestaoAtual);
